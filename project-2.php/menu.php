<div class="row mt-2">
      <div class="col-12">
        ...
        <nav class="navbar navbar-expand-lg bg-warning.bg-gradient sticky-top text-light rounded-4" data-bs-theme="bluex  ">
          <div class="container-fluid">
            <a class="navbar-brand" href="#">
                 <img src="gambar/logo.png" alt="STTNF" width="42" height="42" class="me-2">
                 <span class="text-primary">W.R | </span><span class="text-danger">Pak IMIN</span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse-c115ce46-74c1-4545-b8a8-2bdaa51d2552">
              <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                <!-- <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="navbar-dropdown-c115ce46-74c1-4545-b8a8-2bdaa51d2552">
                    <li>
                      <a class="dropdown-item" href="katalog.html">Gambar</a>
                    </li>
                    <li>
              ...
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                  <a class="btn btn-primary" href="login.php" aria-current="page">Login</a>
                </li>
              </ul>
            </div>
          </div>
